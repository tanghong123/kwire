...
[![Kwire — guided tour](docs/media/kwire-tour.gif)](https://github.com/tanghong123/kwire/releases/download/v2.1.0/kwire-tour.mp4)

> ▶ The preview above is sped up — [watch the full-quality video](https://github.com/tanghong123/kwire/releases/download/v2.1.0/kwire-tour.mp4) (also attached to the [v2.1.0 release](https://github.com/tanghong123/kwire/releases/tag/v2.1.0)).
